      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log(data);
            url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe'; //TODO send email verification
...
var stripe = Stripe('pk_test_51HLCw8Clba6dgGKLJWySkLZZR93dJAdLQMIKRx4JhOoXJHN8DQN2XqPzDSgEZYMcm7XFo7thbLpjY2zsBhtd7zJc00snikGMPs');

exports.subscribeUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(subscriptionType) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("/api/v1/subscriptions/checkout-session/".concat(subscriptionType));
...
var userSettingsForm = document.querySelector('#user-settings');
var userPasswordForm = document.querySelector('#password-form');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    (0, _signup.signup)("".concat(firstname, " ").concat(lastname), email, password);
  });
}
...
if (subscribeButton.length > 0) {
  var _iterator = _createForOfIteratorHelper(subscribeButton),
      _step;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  subscriptionType = e.target.dataset.subscriptionType;
                  _context3.next = 4;
                  return (0, _stripe.subscribeUser)(subscriptionType);
